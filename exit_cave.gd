...
var dialog = [
	{"name": "Garu", "text": "Ahh, nice and fresh air-", "emotion": "hap"},
	{"name": "Garu", "text": "What happened here?! It looks… so gloomy..", "emotion": "sad"},
	{"name": "Garu", "text": "Better hurry up and look for my friends.", "emotion": "norm"},
	{"name": "Garu", "text": "Ah! I see someone over there!", "emotion": "sup"},
	{"name": "Garu", "text": "I wonder if they know anything about my friend’s whereabouts.", "emotion": "norm"}
]
